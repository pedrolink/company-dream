...
// $skill1 = trim($_POST['select_skills_1']);
// $skill2 = trim($_POST['select_skills_2']);
// $skill3 = trim($_POST['select_skills_3']);
...
// $sql_delete_skills = 'DELETE FROM user_skills WHERE user_id = "' . $user_id . '"';

// if($conection->query($sql_delete_skills) === TRUE){
...
// } else {
//     $_SESSION['status_delete_user_skills'] = true;
//     $conection->close();
