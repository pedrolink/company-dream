<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <form action="data_user_profile.php" method="POST" enctype="multipart/form-data">
                <div class="col-md-12">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-start align-items-sm-center gap-4">
                                ...
                                <img src="../images/user/<?php echo $row_user['user_image'] ?>" alt="user-avatar"
                                    class="d-block rounded" id="uploadedAvatar" width="100" height="100">
                                <?php else: ?>
                                <img src="../assets/img/avatars/default-avatar-1.png" alt="user-avatar"
                                    class="d-block rounded" id="uploadedAvatar" width="100" height="100">
                                <?php endif ?>
                                <div class="button-wrapper">
                                    ...
                                    <input type="hidden" name="input_user_image"
                                        value="<?php echo $row_user['user_image'] ?>">
                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="first_name" name="first_name"
                                        value="<?php echo $row_user['first_name'] ?>" autofocus="" required>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="lastName" class="form-label">Sobrenome</label>
                                    <input class="form-control" type="text" name="last_name" id="last_name"
                                        value="<?php echo $row_user['last_name'] ?>" required>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="email" class="form-label">E-mail</label>
                                    <input class="form-control" type="email" id="email" name="email"
                                        value="<?php echo $row_user['email'] ?>" placeholder="example@gmail.com"
                                        required>
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="text" id="phone_number" name="phone_number" class="form-control"
                                            ...
                                            value="<?php echo $row_user['phone_number'] ?>">
                                    </div>
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="address" class="form-label">Endereço</label>
                                    <input type="text" class="form-control" id="address" name="address"
                                        value="<?php echo $row_user_address['address'] ?>">
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label for="city" class="form-label">Cidade</label>
                                    <input class="form-control" type="text" id="city" name="city"
                                        value="<?php echo $row_user_address['city'] ?>">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="zipCode" class="form-label">CEP</label>
                                    <input type="text" class="form-control" id="cep" name="cep" maxlength="8"
                                        value="<?php echo $row_user_address['cep'] ?>">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label class="form-label" for="country">Estado</label>
                                    <select id="state" name="state" class="select2 form-select">
                                        <option value="<?php echo $row_user_address['state'] ?>">
                                            <?php echo $row_user_address['state'] ?> </option>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="district" name="district"
                                        value="<?php echo $row_user_address['district'] ?>">
                                </div>
                                <div class="mb-3 col-md-6">
                                    <label for="birth_date" class="form-label">Data Nascimento</label>
                                    <input type="date" class="form-control" id="birth_date" name="birth_date"
                                        value="<?php echo $row_user['birth_date'] ?>">
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="url_linkedin" name="url_linkedin"
                                        ...
                                        value="<?php echo $row_user['url_linkedin'] ?>">
                                </div>
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="url_cloud" name="url_cloud"
                                        ...
                                        value="<?php echo $row_user['url_cloud'] ?>">
                                </div>
